...
#define PIDTEMP
#define BANG_MAX 70 // <-- changed:  Limits current to nozzle while in bang-bang mode; 255=full current
#define PID_MAX 74 // <-- changed:  Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-54, 0, -4.0} // <-- changed
...
#define XY_PROBE_FEEDRATE 3960 // <-- changed
