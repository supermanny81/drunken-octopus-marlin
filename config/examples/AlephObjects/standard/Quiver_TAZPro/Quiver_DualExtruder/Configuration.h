...
#define SWITCHING_NOZZLE // <-- changed
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES {55,120}   // <-- changed: A pair of angles for { E0, E1 }.
...
#define Z_PROBE_OFFSET_RANGE_MIN  -2 // <-- changed: (mm)
#define Z_PROBE_OFFSET_RANGE_MAX   5 // <-- changed: (mm)
